  ...
  return (
    <UI>
      <Flex as={'main'} alignItems={'center'}
        ...
        <Flex as={'header'}
          flexDirection={'column'}>
          <Heading as={'h1'} fontWeight={400}>Calories
                        Counter</Heading>
          <Text fontSize={'xl'}>Input your
        ...
        >
          ...
          <FormControl as="fieldset"
            ...
            >
              ...
              <option value="1.725">Active:
                                daily exercise
                                or intense 3/4 times/week
              </option>
              <option value="1.9">Very active:
                                intense
                                exercise 6/7 times/week
              </option>
              <option value="2.2">Extra
                                active: very
                                intense exercise daily or
                                physical job
              </option>
            </Select>
          </FormControl>
          ...
          AMR && BMR &&
                    <Flex flexDirection={'column'}
                      ...
                      <Flex flexDirection={'column'}
                        ...
                        gap={2}>
                        <Badge
                          textTransform={'capitalize'}>Total
                                daily energy
                                expenditure rete:</Badge>
                        <Text display={'flex'}
                          alignItems={'center'}
                          fontSize={'2xl'}>
                          {AMR} Kcal
                        ...
                        <Badge
                          textTransform={'capitalize'}>Base
                                metabolic rete: </Badge>
                        <Text display={'flex'}
                          alignItems={'center'}
                          fontSize={'2xl'}>
                          {BMR} Kcal
